...
const app = Router();
const { saloonRegistration, viewssaloonrequest, add_Saloon_View, viewSaloon, getSaloonsDataTable, saloonAllRequistDatatable, saloonApproval } = require('./controller');
